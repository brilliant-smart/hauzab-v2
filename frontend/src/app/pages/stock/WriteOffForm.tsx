...
import { useWriteOff } from "@/app/api/stock";
...
export default function WriteOffForm() {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    mutation.mutate(
      ...
      {
        onSuccess: () => {
          toast.success(`Wrote off ${values.quantity} from ${product.name}`);
          setProduct(null);
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="Write-off Stock" />
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Quantity to Write Off <span className="text-destructive">*</span></FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="e.g. damage, expiry, theft" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
